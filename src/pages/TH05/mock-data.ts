...
export const initialClubs: Club[] = [
  ...
  {
    id: '2',
    avatar: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSPAQYbgN6RBrx4ptRkpSfOpCsML7pPudmY_Q&s',
    name: 'CLB Thể thao',
  ...
  {
    id: '3',
    avatar: 'https://upload.wikimedia.org/wikipedia/commons/thumb/e/e0/Anonymous.svg/960px-Anonymous.svg.png',
    name: 'CLB Lập trình',
